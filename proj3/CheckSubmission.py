...
parser = argparse.ArgumentParser(description='Sanity check project 3 submission.');
...
try:
    ...
    if os.path.exists("Check.jar"):
        print "Running Benchmark."
        print
        call(["java","-jar","Check.jar"]);
    else:
        print "No Check.jar found."
